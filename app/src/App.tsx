...
function App() {
  ...
  const portfolioData = [
    ...
    { id: 2, src: '/images/portfolio_hair1.jpg', category: 'Hair', aspect: 'aspect-square', offset: 'mt-0 lg:mt-12' },
    { id: 3, src: '/images/portfolio_makeup1.jpg', category: 'Makeup', aspect: 'aspect-[4/5]', offset: 'mt-0' },
    { id: 4, src: '/images/portfolio_nails1.jpg', category: 'Nails', aspect: 'aspect-square', offset: 'mt-0 lg:mt-24' },
  ];
